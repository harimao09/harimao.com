...
class EditProfile extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if(nextProps.profile.profile) {
      ...
      profile.social.instagram = !isEmpty(profile.social.bio) ? profile.social.instagram : '';
            ...
            <div className="col-md-8 m-auto">
              ...
              <form onSubmit = { this.onSubmit }>
                ...
                <TextFieldGroup
                  ...
                  info="If you want to latest reposand a Github link, include your username"
                />
                <TextAreaFieldGroup
                ...
                { socialInputs }
                <input type="submit" value="Submit" className="btn btn-info btn-block btn-mt-4" />
              </form>
            </div>
          </div>
        </div>
